    ...
    >(
      () => ({
        ...
        canDrag: () => {
          ...
          // const dropResultInfo ={}
          console.log(dropResultInfo)
          console.log(dropResultInfo?.isDropOnCanvas)
          endDrag(draggedItem.item, dropResultInfo?.isDropOnCanvas ?? true)
          // endDrag(draggedItem.item, true)
        },
        item: () => {
